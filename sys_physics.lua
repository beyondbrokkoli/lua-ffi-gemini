...
function Physics.IntegrateKinematics(dt)
    for i = 0, Pool_Kinematic_Count - 1 do
        ...
        local rtx, rty, rtz = cy, 0, -sy -- [PATCHED] Welcome back, rty!
        
        Obj_FWX[id], Obj_FWY[id], Obj_FWZ[id] = fwx, fwy, fwz
        Obj_RTX[id], Obj_RTY[id], Obj_RTZ[id] = rtx, rty, rtz -- [PATCHED] Saving RTY to memory
        Obj_UPX[id] = fwy * rtz
...
function Physics.ResolveCollisions()
    -- ==========================================================
    -- 1. SLIDE COLLIDERS (Objects bound to a specific slide)
    -- ==========================================================
    for i = 0, Pool_SlideCollider_Count - 1 do
        ...
        -- [PATCHED] True 3D Oriented Bounding Box (OBB) Collision
    ...
    -- ==========================================================
    -- 2. DEEP SPACE ASTEROIDS (Free-roaming objects)
    -- ==========================================================
