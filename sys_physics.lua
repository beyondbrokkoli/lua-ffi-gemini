...
function Physics.ResolveCollisions()
    ...
    -- ==========================================
    -- POOL 1: LOCAL SLIDE OBJECTS (Crystals & Donuts)
    -- Unified Pass: Drag -> Global -> Sphere -> Slide
    -- ==========================================
    ...
    -- ==========================================
    -- POOL 2: DEEP SPACE OBJECTS (Asteroids)
    -- Unified Pass: Drag -> Global -> ALL Slides (NO SPHERES!)
    -- ==========================================
    for i = 0, Pool_DeepSpace_Count - 1 do
        ...
        -- Asteroids check collision against the 4 slide panels, completely bypassing spheres
