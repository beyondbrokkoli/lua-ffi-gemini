...
-- The Dedicated Slide Physics Pool
...
Obj_RTX = ffi.new("float[?]", MAX_OBJS); Obj_RTZ = ffi.new("float[?]", MAX_OBJS)
...
Sphere_X = ffi.new("float[?]", MAX_SLIDES); Sphere_Y = ffi.new("float[?]", MAX_SLIDES); Sphere_Z = ffi.new("float[?]", MAX_SLIDES)
...
Box_NX = ffi.new("float[?]", MAX_SLIDES); Box_NZ = ffi.new("float[?]", MAX_SLIDES)
...
Way_X = ffi.new("float[?]", MAX_SLIDES); Way_Y = ffi.new("float[?]", MAX_SLIDES); Way_Z = ffi.new("float[?]", MAX_SLIDES)
Way_Yaw = ffi.new("float[?]", MAX_SLIDES); Way_Pitch = ffi.new("float[?]", MAX_SLIDES)
